...
class TestScriptedFields(TestData):
    ...
    def test_add_new_scripted_field(self):
        ...
        ed_flights._query_compiler.add_scripted_field('scripted_field_None', None,  np.dtype('int64'))

        buf = StringIO()
        ed_flights._query_compiler._mappings.info_es(buf)
        print(buf.getvalue())

        buf = StringIO()
        self.ed_flights()._query_compiler._mappings.info_es(buf)
        print(buf.getvalue())
    ...
    def test_ecommerce_selected_non_numeric_source_fields(self):
        ...
        ed_numeric = ed_ecommerce._query_compiler._mappings.numeric_source_fields(include_bool=False)
